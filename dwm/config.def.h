...
#define script(...) ((const char *[]){ "/bin/sh", PREFIX "/libexec/dwm/scripts/" __VA_ARGS__, NULL })
...
static const Key keys[] = {
	...
	{ MODKEY,           			XK_a,      spawn,          	{.v = dmscript("dmenu_login", "Tab") } },
	{ MODKEY|ShiftMask,           	XK_a,      spawn,          	{.v = dmscript("dmenu_login", "Enter") } },
	{ MODKEY,						XK_i,	   spawn,		   	{.v = dmscript("dmenu_insert") }},
	{ MODKEY|ShiftMask,				XK_i,	   spawn,		   	{.v = script("add_snippet") }},
	{ MODKEY,						XK_s,	   spawn,		   	{.v = dmscript("dmenu_surf") }},
	{ MODKEY|ShiftMask,				XK_s,	   spawn,		   	{.v = dmscript("dmenu_surf_history") }},
	{ MODKEY|ControlMask,			XK_s,	   spawn,		   	{.v = dmscript("dmenu_schule") }},
